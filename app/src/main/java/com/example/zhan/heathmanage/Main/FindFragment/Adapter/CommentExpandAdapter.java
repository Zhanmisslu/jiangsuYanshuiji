...
public class CommentExpandAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpand, View convertView, ViewGroup viewGroup) {
        ...
        //groupHolder.reply_item_user1.setText("誉姐");
...
//        });
    ...
    private class GroupHolder{
        ...
        public GroupHolder(View view) {
            logo = (RoundedImageView) view.findViewById(R.id.comment_item_logo);
...
//子视图
    private class ChildHolder{
        private TextView tv_name, tv_content,reply_item_user1;
        public ChildHolder(View view) {
            tv_name = (TextView) view.findViewById(R.id.reply_item_user);
            tv_content = (TextView) view.findViewById(R.id.reply_item_content);
            reply_item_user1= (TextView) view.findViewById(R.id.reply_item_user1);
        }
    }
