...
public class AttentionAdapter extends RecyclerView.Adapter<AttentionAdapter.AttentionViewHolder> {
    ...
    public class AttentionViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.attentionitem_nickname_tv)TextView attentionitem_nickname_tv;
        @BindView(R.id.attentionitem_content_tv)TextView attentionitem_content_tv;
        @BindView(R.id.attentionitem_image_riv)RoundedImageView attentionitem_image_riv;
        @BindView(R.id.attentionitem_time_tv)TextView attentionitem_time_tv;
        @BindView(R.id.attentionitem_picture1_iv)ImageView attentionitem_picture1_iv;
        @BindView(R.id.attentionitem_supportnum_tv)TextView attentionitem_supportnum_tv;
        @BindView(R.id.attentionitem_commentnum_tv)TextView attentionitem_commentnum_tv;
        @BindView(R.id.attentionitem_commentnum_ll)LinearLayout attentionitem_commentnum_ll;
        @BindView(R.id.attentionitem_supportnum_ll)LinearLayout attentionitem_supportnum_ll;
        @BindView(R.id.attentionitem_supportnum_iv)ImageView attentionitem_supportnum_iv;
