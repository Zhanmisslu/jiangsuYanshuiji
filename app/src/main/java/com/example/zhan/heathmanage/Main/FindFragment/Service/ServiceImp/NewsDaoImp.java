...
public class NewsDaoImp implements NewsDao {
    ...
    public NewsDaoImp(FashionFragment fashionFragment) {
        this.fashionFragment = fashionFragment;
    }

    public NewsDaoImp(HeathFragment heathFragment) {
        ...
        OKHttp.sendOkhttpGetRequest(url, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    heathFragment.InitHealthData(newsBeanList);
        ...
        OKHttp.sendOkhttpGetRequest(url, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    fashionFragment.InitFashionData(fashionList);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
