...
public class WeeklyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weekly_web.setWebViewClient(webViewClient);

        WebSettings webSettings = weekly_web.getSettings();
...
//        webSettings.setDisplayZoomControls(false);
        ...
        //加载框初始化
        zLoadingDialog = new ZLoadingDialog(WeeklyActivity.this);
...
//                                .setDurationTime(0.5) // 设置动画时间百分比
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if(url.equals("http://www.google.com/")){
                Toast.makeText(WeeklyActivity.this,"国内不能访问,拦截该url",Toast.LENGTH_LONG).show();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        Log.i("ansen","是否有上一个页面:"+weekly_web.canGoBack());
        if (weekly_web.canGoBack() && keyCode == KeyEvent.KEYCODE_BACK){//点击返回按钮的时候判断有没有上一页
            weekly_web.goBack(); // goBack()表示返回webView的上一页面
            return true;
        }
