...
public class Net {
    ...
    public final static String ShowLatestData = Head + "ShowLatestData"; //得到昨日信息
    public final static String ChangeUserInfo = Head + "ChangeUserInfo";//修改个人信息
    public final static String ClickToReport = Head + "ClickToReport";//一件生成报告
    public final static String GetUserEvalute = Head + "IndexInfo";//得到用户的建议
    ...
    public final static String GetSuggest = Head + "GetDataByMonth";//月视图数据
